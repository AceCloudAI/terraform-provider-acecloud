...
- `monitor_http_method` (String) HTTP method for health checks. One of: `GET`, `POST`, `PUT`, `DELETE`, `PATCH`, `HEAD`, `OPTIONS`.
- `monitor_protocol` (String) Protocol for health monitoring. One of: `PING`, `TCP`, `HTTP`, `HTTPS`, `UDP-CONNECT`.
...
- `listener_protocol` (String) Protocol for the listener. One of: `TCP`, `HTTP`, `HTTPS`, `TERMINATED_HTTPS`, `PROXY`, `UDP`.
...
- `lb_algorithm` (String) Load balancing algorithm. One of: `ROUND_ROBIN`, `LEAST_CONNECTIONS`, `SOURCE_IP`, `SOURCE_IP_PORT`.
- `pool_protocol` (String) Protocol for the pool. One of: `TCP`, `HTTP`, `HTTPS`, `TERMINATED_HTTPS`, `PROXY`, `UDP`.
