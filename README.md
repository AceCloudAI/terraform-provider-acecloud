...
[![Go Reference](https://pkg.go.dev/badge/github.com/AceCloudAI/terraform-provider-acecloud.svg)](https://pkg.go.dev/github.com/AceCloudAI/terraform-provider-acecloud)
[![Go Report Card](https://goreportcard.com/badge/github.com/AceCloudAI/terraform-provider-acecloud)](https://goreportcard.com/report/github.com/AceCloudAI/terraform-provider-acecloud)
...
The provider is published to the [Terraform Registry](https://registry.terraform.io/providers/AceCloudAI/acecloud/latest). Add it to your Terraform configuration:
...
Full documentation lives on the [Terraform Registry](https://registry.terraform.io/providers/AceCloudAI/acecloud/latest/docs):

- [Getting Started](https://registry.terraform.io/providers/AceCloudAI/acecloud/latest/docs)
- [Provider Configuration](https://registry.terraform.io/providers/AceCloudAI/acecloud/latest/docs)
...
See the [Authentication guide](https://registry.terraform.io/providers/AceCloudAI/acecloud/latest/docs) for details.
...
```bash
git clone https://github.com/AceCloudAI/terraform-provider-acecloud
...
- **Bugs**: [open an issue](https://github.com/AceCloudAI/terraform-provider-acecloud/issues/new) using the bug report template
