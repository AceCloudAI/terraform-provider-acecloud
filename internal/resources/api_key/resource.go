...
// createRequest is the body for POST /iam/api-keys.
type createRequest struct {
	ServiceName string `json:"serviceName"`
	Description string `json:"description,omitempty"`
}

// updateRequest is the body for PATCH /iam/api-keys/:id.
...
// keyResponse is the shape returned by the the API on create / read / update.
...
// parseKeyResponse parses the the API response data into a keyResponse.
