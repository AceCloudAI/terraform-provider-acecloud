...
func mapAPIResponseToState(model *volumeBackupResourceModel, apiResp *backupAPIResponse) {
	...
	// `force` is a create-time-only flag; the API does not echo it back.
	// Normalise the state value so a null/unknown plan input ends up as
	// the concrete default (false) after apply.
...
func (r *volumeBackupResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	// Backup create uses: POST /backups (the API routes backups at /backups)
	createPath := "/backups"
...
func (r *volumeBackupResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	// Read uses: GET /cloud/volume-backups/{id} (the API cloud wrapper)
...
func (r *volumeBackupResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	// Update uses: PUT /backups/{id} (the API routes backups at /backups)
...
func (r *volumeBackupResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	...
	// Delete uses: DELETE /backups (the API routes backups at /backups)
	deletePath := "/backups"
	...
	// the API returns: "Backup status must be available or error"
	// the API returns: "Incremental backups exist for this backup"
